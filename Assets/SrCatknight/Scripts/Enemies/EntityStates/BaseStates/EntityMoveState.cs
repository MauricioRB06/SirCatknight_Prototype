...
namespace SrCatknight.Scripts.Enemies.EntityStates.BaseStates
{
    public class EntityMoveState : EntityState
    {
        ...
        private readonly DataEntityMoveState _dataEntityMoveState;
        ...
        {
            this._dataEntityMoveState = dataEntityMoveState;
        }
        ...
        public override void Enter()
        {
            ...
            Core.Movement.SetVelocityX(_dataEntityMoveState.MovementSpeed * Core.Movement.FacingDirection);
        }
