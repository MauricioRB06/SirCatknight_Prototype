...
namespace SrCatknight.Scripts.Levels.General
{
    ...
    public class LauncherObject: MonoBehaviour
    {
        ...
        private Animator _launcherAnimator;
        ...
        private void Awake()
        {
            ...
            else
            {
                ...
                _launcherAnimator = GetComponent<Animator>();
            }
        }
        ...
        private void Update()
        {
            ...
            {
                _waitedTime = launchAttackTime;
                _launcherAnimator.SetTrigger(Attack);
            }
            else
            {
        ...
        private void AnimationFinishTrigger() => _launcherAnimator.SetTrigger(Reload);
    }
}
