...
namespace SrCatknight.Scripts.Levels.General
{
    ...
    public class ExplosiveObject : MonoBehaviour
    {
        ...
        private PolygonCollider2D _bombActivationZone;
        
        // Object that will be created when the bomb explodes.
        private GameObject _explosionZone;
        ...
        private void Awake()
        {
            ...
            _bombActivationZone = GetComponent<PolygonCollider2D>();
            ...
            {
                _explosionZone = transform.GetChild(0).gameObject;
                _bombActivationZone.isTrigger = true;
                _explosionZone.SetActive(false);  
            }
        }
        ...
        private void OnTriggerEnter2D(Collider2D collision)
        {
            ...
            _boomAnimator.SetTrigger(BombActivated);
            _bombActivationZone.enabled = false;
        ...
        {
            _bombActivationZone.enabled = !_bombActivationZone.enabled;
        }
    }
}
