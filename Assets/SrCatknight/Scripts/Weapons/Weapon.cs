...
namespace SrCatknight.Scripts.Weapons
{
    public class Weapon : MonoBehaviour
    {
        ...
        // 
        protected SrCatknight.Scripts.Core.Core Core;
        ...
        public void InitializeWeapon(PlayerAttackState attackState, SrCatknight.Scripts.Core.Core core)
        {
