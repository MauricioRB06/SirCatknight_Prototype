...
namespace Player.Input
{
    public class PlayerInputHandler : MonoBehaviour
    {
        ...
        private InputControl _keyboard;
        private InputControl _gamepad;
        private string _device;
        
        public static event Action<string> InputDeviceDelegate;
        ...
        private void Awake()
        {
            ...
            _device = _gamepad != null ? _gamepad.displayName : _keyboard.displayName;
        }
        ...
        {
            if (context.control.device.displayName != _device)
            {
                _device = context.control.device.displayName;
                InputDeviceDelegate?.Invoke(_device);
            }
        ...
        // 
        public string CheckInputDevice() => _device;
