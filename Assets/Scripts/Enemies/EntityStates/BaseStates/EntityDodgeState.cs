...
namespace Enemies.EntityStates.BaseStates
{
    public class EntityDodgeState : EntityState
    {
        ...
        private readonly DataEntityDodgeState dataEntityDodgeState;
        ...
        {
            this.dataEntityDodgeState = dataEntityDodgeState;
        }
        ...
        public override void Enter()
        {
            ...
            Core.Movement.SetVelocity(dataEntityDodgeState.DodgeSpeed, dataEntityDodgeState.DodgeAngle,
        ...
        public override void LogicUpdate()
        {
            ...
            // 
            if (Time.time >= StartTime + dataEntityDodgeState.DodgeTime && IsGrounded)
            {
                IsDodgeOver = true;
            }
        }
