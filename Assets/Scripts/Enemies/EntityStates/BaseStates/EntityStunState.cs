...
namespace Enemies.EntityStates.BaseStates
{
    public class EntityStunState : EntityState
    {
        ...
        private readonly DataEntityStunState dataEntityStunState;
        ...
        {
            this.dataEntityStunState = dataEntityStunState;
        }
        ...
        public override void Enter()
        {
            ...
            Core.Movement.SetVelocity(dataEntityStunState.StunKnockBackSpeed, dataEntityStunState.StunKnockBackAngle,
        ...
        public override void LogicUpdate()
        {
            ...
            if (Time.time >= StartTime + dataEntityStunState.StunTime)
            {
                IsStunTimeOver = true;
            }
            
            // If ground is detected and the KnockBack movement has not been stopped.
            if (IsGrounded && Time.time >= StartTime + dataEntityStunState.StunKnockBackTime && !IsMovementStopped)
            {
