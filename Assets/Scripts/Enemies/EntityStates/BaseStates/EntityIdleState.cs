...
namespace Enemies.EntityStates.BaseStates
{
    public class EntityIdleState : EntityState
    {
        ...
        private readonly DataEntityIdleState dataEntityIdleState;
        ...
        private bool flipAfterIdleState;
        ...
        {
            this.dataEntityIdleState = dataEntityIdleState;
        }
        ...
        {
            flipAfterIdleState = flip;
        }
        
        // Selects a random idle time, in the range set in the idle state data.
        private void SetRandomIdleTime()
        {
            idleTime = Random.Range(dataEntityIdleState.MinIdleTime, dataEntityIdleState.MaxIdleTime);
        }
    }
}
