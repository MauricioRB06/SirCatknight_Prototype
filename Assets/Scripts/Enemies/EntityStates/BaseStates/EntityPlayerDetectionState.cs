...
namespace Enemies.EntityStates.BaseStates
{
    public class EntityPlayerDetectionState : EntityState
    {
        ...
        private readonly DataEntityPlayerDetection dataEntityPlayerDetection;
        ...
        {
            this.dataEntityPlayerDetection = dataEntityPlayerDetection;
        }
        ...
        public override void LogicUpdate()
        {
            ...
            if (Time.time >= StartTime + dataEntityPlayerDetection.LongRangeActionTime)
            {
