...
namespace Enemies.EntityStates.BaseStates
{
    public class EntityChargeState : EntityState
    {
        ...
        private readonly DataEntityChargeState dataEntityChargeState;
        ...
        {
            this.dataEntityChargeState = dataEntityChargeState;
        }
        ...
        public override void Enter()
        {
            ...
            Core.Movement.SetVelocityX(dataEntityChargeState.EntityChargeSpeed * Core.Movement.FacingDirection);
        }
        ...
        public override void LogicUpdate()
        {
            ...
            if (Time.time >= StartTime + dataEntityChargeState.EntityChargeTime)
            {
